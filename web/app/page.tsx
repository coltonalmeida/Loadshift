  ...
  return (
    <main className="mx-auto max-w-5xl px-5 pb-20">
      ...
      <section id="now" className="scroll-mt-20">
        <div className="grid gap-10 pb-4 pt-14 lg:grid-cols-[1.2fr_1fr] lg:gap-16">
          <div>
            ...
            <p className="mt-5 max-w-[52ch] text-lg leading-relaxed text-ink-2">
              Ontario&rsquo;s grid is mostly clean. The plant that ramps up for
              your extra load is not. We forecast the difference, hour by hour.
            </p>
        ...
        {now && (
          <div className="mono mt-8 flex flex-wrap gap-x-6 gap-y-1 text-xs text-ink-3">
      ...
      {/* ── Schedule ────────────────────────────────────────── */}
      <section id="schedule" className="mt-16 scroll-mt-20 border-t border-line pt-14">
        <ScheduleSection fc={fc} wake={wake} bed={bed} setWakeBed={setWakeBed} />
      </section>

      {/* ── Your data ───────────────────────────────────────── */}
      <section id="data" className="mt-16 scroll-mt-20 border-t border-line pt-14">
        <DataSection />
      </section>
